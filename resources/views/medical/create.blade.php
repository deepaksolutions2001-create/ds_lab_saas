    ...
    <div class="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            <div class="flex items-center gap-3 mb-2">
                <span class="px-3 py-1 bg-blue-100 text-blue-700 text-[10px] font-black uppercase tracking-widest rounded-full border border-blue-200">Clinical Workflow v2.1</span>
                <span class="text-slate-300">/</span>
                <span class="text-slate-400 text-[10px] font-black uppercase tracking-widest">{{ now()->format('M d, Y') }}</span>
            </div>
            <h1 class="text-5xl font-black text-slate-900 tracking-tighter uppercase leading-none">Register <span class="text-blue-600">Medical Case</span></h1>
            <p class="text-slate-500 font-medium mt-3 max-w-xl">Initialize a new patient diagnostic record with coordinated referral tracking and dynamic lab result mapping.</p>
        </div>
        <div class="flex items-center gap-4">
            <a href="{{ route('medical.index') }}" class="px-6 py-3 rounded-2xl bg-white border border-slate-200 text-slate-500 font-bold text-sm hover:bg-slate-50 transition-all">
                Cancel
            </a>
            <button type="button" onclick="document.getElementById('medicalReportForm').submit()" class="px-8 py-3 rounded-2xl bg-blue-600 text-white font-black text-sm uppercase tracking-widest shadow-xl shadow-blue-500/30 hover:bg-blue-700 transition-all">
                Finalize Record
            </button>
        </div>
    </div>

    <form action="{{ route('medical.store') }}" method="POST" id="medicalReportForm">
        @csrf
            ...
            <div class="lg:col-span-12 xl:col-span-12 space-y-10">
                    ...
                    <div class="p-10 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p class="text-[9px] text-slate-400 font-black uppercase tracking-[0.2em] mt-1.5">Official demographics and travel credentials</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="text-[10px] font-black text-slate-300 uppercase tracking-widest block">Reference No</span>
                            <span class="text-xs font-mono font-black text-blue-600 tracking-tighter">AUTO-GENERATED</span>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                            <div class="md:col-span-8 space-y-2">
                                ...
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-6 flex items-center text-slate-300 group-focus-within:text-blue-500 transition-colors pointer-events-none">
                                        <i class="fas fa-user-tag text-sm"></i>
                                    </div>
                                    <input type="text" name="patient_name" 
                                           class="w-full pl-14 pr-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-black text-slate-800 text-lg placeholder-slate-300 uppercase tracking-tight"
                            ...
                            <div class="md:col-span-4 space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="passport_no" 
                                           class="w-full pl-14 pr-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-black text-blue-600 tracking-widest placeholder-slate-300 uppercase"
                            ...
                            <div class="md:col-span-4 space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <select name="occupation_id" 
                                            class="w-full pl-14 pr-10 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:border-blue-500 outline-none transition-all font-black text-slate-700 appearance-none cursor-pointer">
                            ...
                            <div class="md:col-span-4 space-y-2">
                                ...
                                <input type="text" name="father_name" 
                                       class="w-full px-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:border-blue-500 outline-none transition-all font-bold text-slate-700 placeholder-slate-300 uppercase"
                            ...
                            <div class="md:col-span-3 space-y-2">
                                ...
                                <input type="date" name="dob" 
                                       class="w-full px-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:border-blue-500 outline-none transition-all font-bold text-slate-700">
                            </div>

                            <div class="md:col-span-2 space-y-2">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Gender</label>
                                <select name="gender" class="w-full px-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:border-blue-500 outline-none transition-all font-bold text-slate-700 appearance-none cursor-pointer">
                            ...
                            <div class="md:col-span-3 space-y-2">
                                ...
                                <input type="date" name="medical_date" value="{{ date('Y-m-d') }}"
                                       class="w-full px-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:border-blue-500 outline-none transition-all font-bold text-slate-700">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                    <div class="p-10 border-b border-slate-50 flex items-center gap-5 bg-slate-50/30">
                        ...
                        <div>
                            ...
                            <p class="text-[9px] text-slate-400 font-black uppercase tracking-[0.2em] mt-1.5">Direct physical examination & vitals data</p>
                        </div>
                    </div>
                    ...
                    <div class="p-10">
                        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input type="text" name="height" class="w-full pl-6 pr-12 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:border-orange-500 outline-none transition-all font-black text-slate-700" placeholder="0">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input type="text" name="weight" class="w-full pl-6 pr-12 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:border-orange-500 outline-none transition-all font-black text-slate-700" placeholder="0">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input type="text" name="bp" class="w-full px-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:border-orange-500 outline-none transition-all font-black text-slate-700" placeholder="120/80">
                ...
                <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                    <div class="p-10 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p class="text-[9px] text-slate-400 font-black uppercase tracking-[0.2em] mt-1.5">Specified medical tests and clinical outcomes</p>
                            </div>
                        </div>
                    ...
                    <div id="diagnostics_container" class="p-10 space-y-6">
                        <!-- Dynamic Test Modules Injected Here -->
                ...
                <div class="bg-slate-900 rounded-[2.5rem] shadow-2xl shadow-slate-500/20 p-10 lg:p-14 text-white overflow-hidden relative">
                    ...
                    <div class="absolute bottom-0 left-0 w-64 h-64 bg-purple-500/10 blur-[100px] rounded-full pointer-events-none"></div>
                    ...
                    <div class="flex items-center gap-5 mb-14 border-b border-white/5 pb-10">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em] mt-2">Referral settlement & Ledger reconciliation</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
                        ...
                        <div class="md:col-span-3 space-y-3">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="amount_required" id="amount_required" 
                    ...
                    <div id="balance_indicator" class="mt-12 p-8 rounded-[2rem] bg-white/5 border border-white/5 flex items-center justify-between hidden transition-all">
                        <div class="flex items-center gap-4">
                ...
                <div class="flex items-center justify-center gap-8 py-10">
                    <button type="submit" class="px-20 py-7 bg-blue-600 text-white rounded-[2.5rem] font-black text-lg uppercase tracking-[0.3em] shadow-3xl shadow-blue-600/50 hover:bg-blue-500 hover:-translate-y-2 transition-all active:scale-95 group relative overflow-hidden">
                        <span class="relative z-10 flex items-center gap-6">
                            ISSUE CLINICAL REPORT
...
<script>
    ...
    testSelector.addEventListener('change', function() {
        ...
        if (!testId || selectedTests.has(testId)) {
            this.value = '';
            return;
        }
